...
Blockly.Msg.VARIABLES_SET = "mettre la variable %1 à %2";
...
Blockly.Msg.CAT_IZIMAKERS_DEBUG = "Debug";

Blockly.Msg.CAT_IZIMAKERS_IN = "In";
Blockly.Msg.CAT_IZIMAKERS_OUT = "Out";
Blockly.Msg.CAT_IZIMAKERS_LCD = "LCD screen";
...
Blockly.Msg.CAT_IZIMAKERSV2_DEBUG = "Debug";

Blockly.Msg.CAT_IZIMAKERSV2_IN = "In";
...
Blockly.Msg.IZIMAKERS_JOYSTICK_TEXT2 = "Axe";
//Blockly.Msg.IZIMAKERS_JOYSTICK_INPUT = "PIN#";
Blockly.Msg.IZIMAKERS_JOYSTICK_AXES = [["X", "x"],  ["Y", "y"]];
Blockly.Msg.IZIMAKERS_JOYSTICK_TOOLTIP = "Joystick [-100 .. 100]";

Blockly.Msg.IZIMAKERS_ULTRASONIC_HELPURL = "";
Blockly.Msg.IZIMAKERS_ULTRASONIC_TEXT = "Distance Ultrasonic";
Blockly.Msg.IZIMAKERS_ULTRASONIC_INPUT = "PIN#";
Blockly.Msg.IZIMAKERS_ULTRASONIC_UNIT = "unité";
Blockly.Msg.IZIMAKERS_ULTRASONIC_UNIT_CHOICE = [["cm", "cm"],  ["pouces", "inch"]];
Blockly.Msg.IZIMAKERS_ULTRASONIC_TOOLTIP = "Mesure de distance Ultrasonic";

Blockly.Msg.IZIMAKERS_DEBUG_SERIAL_HELPURL = "";
Blockly.Msg.IZIMAKERS_DEBUG_SERIAL_TEXT = "Serial debug";
Blockly.Msg.IZIMAKERS_DEBUG_SERIAL_INPUT = "Serial debug";
Blockly.Msg.IZIMAKERS_DEBUG_SERIAL_TOOLTIP = "Send text to host for debugging";

Blockly.Msg.IZIMAKERS_DEBUG_IZISEND_HELPURL = "";
Blockly.Msg.IZIMAKERS_DEBUG_IZISEND_TEXT = "iziSend";
Blockly.Msg.IZIMAKERS_DEBUG_IZISEND_INPUT = "iziSend";
Blockly.Msg.IZIMAKERS_DEBUG_IZISEND_TOOLTIP = "Send text to modules";




Blockly.Msg.IZIMAKERSV2_SETUP_HELPURL = "";
Blockly.Msg.IZIMAKERSV2_SETUP_TEXT = "Configuration";
...
Blockly.Msg.IZIMAKERSV2_INPUT_VOLTAGE_TOOLTIP = "Tension d'alimentation en millivolts";



Blockly.Msg.IZIMAKERSV2_MOTORS_A_HELPURL = "";
Blockly.Msg.IZIMAKERSV2_MOTORS_A_TEXT = "Moteur A";
Blockly.Msg.IZIMAKERSV2_MOTORS_A_INPUT = "Puissance [-100 .. 100]";
//Blockly.Msg.IZIMAKERS_MOTORS_A_EFFECT = "Motor A";
Blockly.Msg.IZIMAKERSV2_MOTORS_A_TOOLTIP = "Moteur à courant continu";

Blockly.Msg.IZIMAKERSV2_MOTORS_B_HELPURL = "";
Blockly.Msg.IZIMAKERSV2_MOTORS_B_TEXT = "Moteur B";
Blockly.Msg.IZIMAKERSV2_MOTORS_B_INPUT = "Puissance [-100 .. 100]";
//Blockly.Msg.IZIMAKERS_MOTORS_A_EFFECT = "Motor A";
Blockly.Msg.IZIMAKERSV2_MOTORS_B_TOOLTIP = "Moteur à courant continu";

Blockly.Msg.IZIMAKERSV2_JOYSTICK_HELPURL = "";
Blockly.Msg.IZIMAKERSV2_JOYSTICK_TEXT1 = "Joystick [-100 .. 100]";
Blockly.Msg.IZIMAKERSV2_JOYSTICK_TEXT2 = "Axe";
//Blockly.Msg.IZIMAKERS_JOYSTICK_INPUT = "PIN#";
Blockly.Msg.IZIMAKERSV2_JOYSTICK_AXES = [["X", "x"],  ["Y", "y"],  ["Bouton", "sw"]];
Blockly.Msg.IZIMAKERSV2_JOYSTICK_TOOLTIP = "Joystick [-100 .. 100]";

Blockly.Msg.IZIMAKERSV2_ULTRASONIC_HELPURL = "";
Blockly.Msg.IZIMAKERSV2_ULTRASONIC_TEXT = "Distance Ultrasonique";
Blockly.Msg.IZIMAKERSV2_ULTRASONIC_INPUT = "PIN#";
Blockly.Msg.IZIMAKERSV2_ULTRASONIC_UNIT = "unité";
Blockly.Msg.IZIMAKERSV2_ULTRASONIC_UNIT_CHOICE = [["cm", "cm"],  ["pouces", "inch"]];
Blockly.Msg.IZIMAKERSV2_ULTRASONIC_TOOLTIP = "Mesure de distance Sonar Ultrasonique";

Blockly.Msg.IZIMAKERSV2_DEBUG_SERIAL_HELPURL = "";
Blockly.Msg.IZIMAKERSV2_DEBUG_SERIAL_TEXT = "Serial debug";
Blockly.Msg.IZIMAKERSV2_DEBUG_SERIAL_INPUT = "Serial debug";
Blockly.Msg.IZIMAKERSV2_DEBUG_SERIAL_TOOLTIP = "Send text to host for debugging";

Blockly.Msg.IZIMAKERSV2_DEBUG_IZISEND_HELPURL = "";
