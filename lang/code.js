...
// Populate the language selection menu.
  ...
  //$('#span_picture').text(MSG['span_picture']);		// iziMakers
  ...
  //$('#a_supervision').text(MSG['span_supervision']);		// iziMakers
  ...
  //$('#btn_doc').attr('title', MSG['span_doc']);  		// iziMakers
  //$('#btn_tuto').attr('title', MSG['span_tuto']); 		// iziMakers
