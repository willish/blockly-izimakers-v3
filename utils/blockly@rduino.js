...
BlocklyDuino.selectedCard = 'iziMakers_nano';
...
BlocklyDuino.buildToolbox = function() {
	...
	if (loadIds === undefined || loadIds === "") {
		loadIds = "CAT_LOGIC,CAT_LOOPS,CAT_MATH,CAT_IZIMAKERSV3,CAT_IZIMAKERS_VARIABLES"; // CAT_VARIABLES,CAT_TEXT,CAT_FUNCTIONS,
	}
...
BlocklyDuino.setOrientation = function() {
	...
	if (newOrientation == 'hor') {
		...
		//$("#div_help_button").addClass("div_help_button-hor");		// iziMakers
		//$("#div_miniPicture").addClass("div_miniPicture-hor");		// iziMakers
...
//		var menuPanelFiles = document.getElementById("menuPanelFiles");
		...
		//$("#btn_picture").addClass("btn_ver");		// iziMakers
