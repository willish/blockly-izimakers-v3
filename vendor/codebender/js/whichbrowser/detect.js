...
this.browser = new Browser({ channel: "Dev", stock: false, hidden: false, mode: "", name: "Chrome", version: new Version({ value: "64.0.3282.119", hidden: false }) });
this.engine = new Engine({ name: "Blink", version: new Version({ value: "537.36", hidden: false }) });
this.os = new Os({ name: "Windows", version: new Version({ value: "6.1", hidden: false, alias: "7" }) });
this.device = new Device({ type: "desktop", subtype: "", identified: 0, generic: true });
